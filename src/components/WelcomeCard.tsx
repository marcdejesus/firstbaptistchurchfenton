    ...
    <Card className="w-full rounded-xl shadow-lg mx-auto my-16">
      <CardContent className="p-4 sm:p-6">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-4">
          <Link href="/welcome" className="self-center sm:self-auto mb-4 sm:mb-0">
            <Image
              src="/welcome.png"
              alt="Welcome!"
              width={200}
          ...
          <div className="flex items-center space-x-2 sm:space-x-3 self-center sm:self-auto">
            <div className="flex space-x-1 sm:space-x-2">
              <a href="https://www.facebook.com/FBCFentonMO" target="_blank" rel="noopener noreferrer">
                <Button variant="ghost" size="icon" className="text-gray-600 hover:text-blue-600 w-8 h-8 sm:w-9 sm:h-9">
                  <Facebook className="w-6 h-6" />
                </Button>
              </a>
              <a href="https://www.youtube.com/@fbcfentonmo" target="_blank" rel="noopener noreferrer">
                <Button variant="ghost" size="icon" className="text-gray-600 hover:text-red-600 w-8 h-8 sm:w-9 sm:h-9">
