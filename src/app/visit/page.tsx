...
export default function VisitPage() {
  return (
    <div className="bg-white">
      <header className="bg-primary text-primary-foreground py-20 md:py-24 text-center">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-heading font-bold">Plan Your Visit</h1>
