...
import { Eye, EyeOff, Mail, Phone, MessageSquare, User, Trash2 } from 'lucide-react';
...
export default function ContactSubmissionsClient({ initialSubmissions }: ContactSubmissionsClientProps) {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast({
          ...
          description: "Contact submission has been permanently deleted.",
        });
      } else {
